# Projeto Tryunfo [View/Ver](https://j-pster.github.io/tryunfo/)
...
1. Clone o repositório
  * `git clone git@github.com:J-Pster/tryunfo.git`
...
Neste projeto eu faço um site em React, aonde eu crio um gerador de cartas com visualização em tempo real para criar cartas no estilo do jogo Triunfo, aqui eu consolidei meus conhecimentos em componentes React, em atualização através de estados destes componentes, em eventos e formulários, além de utilizar callbacks e props para passar informações para elementos filhos.
